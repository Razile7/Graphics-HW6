...
function createBasketballCourt(scale = 1) {
  ...
  const baseColorMap = textureLoader.load('src/textures/laminate-flooring-brown_albedo.png');
  const normalMap = textureLoader.load('src/textures/laminate-flooring-brown_normal-ogl.png');
  const aoMap = textureLoader.load('src/textures/laminate-flooring-brown_ao.png');
...
function createCourtLines(scale = 1.5) {
  ...
  // === Three-Point Arcs ===
  const tpRadius = 6.75 * scale;
  
  // Left three-point arc (semicircle facing right)
  const leftTPArc = new THREE.Mesh(
    new THREE.RingGeometry(tpRadius - lineThickness/2, tpRadius + lineThickness/2, 64, 1, -Math.PI/2, Math.PI), 
    arcMaterial
  );
  leftTPArc.rotation.x = -Math.PI / 2;
  leftTPArc.position.set(-courtLength/2, lineElevation + 0.01 * scale, 0);
  ...
  rightTPArc.position.set(courtLength/2 + 0.1 , lineElevation + 0.01 * scale + 0.1, 0);
  ...
  // const leftTPTop = new THREE.Mesh(new THREE.BoxGeometry(tpStraightLength, lineHeight, lineThickness), lineMaterial);
  // leftTPTop.position.set(-courtLength/2 + tpStraightLength/2, lineElevation, tpStraightDistance);
  
  // const leftTPBottom = new THREE.Mesh(new THREE.BoxGeometry(tpStraightLength, lineHeight, lineThickness), lineMaterial);
  // leftTPBottom.position.set(-courtLength/2 + tpStraightLength/2, lineElevation, -tpStraightDistance);
  
  // // Right three-point straight lines
  // const rightTPTop = new THREE.Mesh(new THREE.BoxGeometry(tpStraightLength, lineHeight, lineThickness), lineMaterial);
  // rightTPTop.position.set(courtLength/2 - tpStraightLength/2, lineElevation, tpStraightDistance);
  
  // const rightTPBottom = new THREE.Mesh(new THREE.BoxGeometry(tpStraightLength, lineHeight, lineThickness), lineMaterial);
  // rightTPBottom.position.set(courtLength/2 - tpStraightLength/2, lineElevation, -tpStraightDistance);
